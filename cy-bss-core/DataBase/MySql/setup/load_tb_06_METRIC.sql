...
insert into BSST_MES_METRIC_SCALE(MET_N_METRIC_ID,MES_S_NAME,MES_S_SIMBOL,MES_N_SCALE)
values (
...
insert into BSST_MES_METRIC_SCALE(MET_N_METRIC_ID,MES_S_NAME,MES_S_SIMBOL,MES_N_SCALE)
values (
	(select MET_N_METRIC_ID from BSST_MET_METRIC where MET_S_NAME='Kilogram'),
	'Kilogram','Kg',1.0
);
insert into BSST_MES_METRIC_SCALE(MET_N_METRIC_ID,MES_S_NAME,MES_S_SIMBOL,MES_N_SCALE)
values (
