...
CREATE TABLE BSST_MNC_MANAGED_COMPANY (
	MNC_N_COMPANY_ID 			INTEGER UNSIGNED NOT NULL,
	MNC_C_ACTIVE				CHAR(1) NOT NULL DEFAULT 'Y',
	MNC_N_INVOICE_LOG			INTEGER UNSIGNED,
	PRIMARY KEY(MNC_N_COMPANY_ID),
	CONSTRAINT BSST_MNC_MANAGED_COMPANY_FK1 FOREIGN KEY(MNC_N_COMPANY_ID) 
