...
CREATE TABLE BSST_PRC_PRICE_COMPONENT (
	...
	PRI_N_PERIOD_METRIC_ID 		INTEGER UNSIGNED,
	UNIQUE(PRC_S_CODE),
	...
	CONSTRAINT BSST_PRC_PRICE_COMPONENT_FK2 FOREIGN KEY(PRI_N_PERIOD_METRIC_ID) 
...
CREATE TABLE BSST_PRI_PRICE (
	...
	PRI_N_PERIOD_SCALE_ID		INTEGER UNSIGNED,
	...
	CONSTRAINT BSST_PRI_PRICE_FK4 FOREIGN KEY(PRI_N_PERIOD_SCALE_ID) 
			REFERENCES BSST_MES_METRIC_SCALE(MES_N_METRIC_SCALE_ID)	
);
