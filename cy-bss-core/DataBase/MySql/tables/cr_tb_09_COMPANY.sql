...
CREATE TABLE BSST_CDE_COMPANY_DEPT (
	...
	PRIMARY KEY(CDE_N_DEPT_ID,COM_N_COMPANY_ID),
...
DROP TABLE BSST_CRO_COMPANY_ROLE_LANG;		

DROP TABLE BSST_CRO_COMPANY_ROLE;
CREATE TABLE BSST_CRO_COMPANY_ROLE(
	CRO_N_ROLE_ID 			INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
	CRO_S_NAME	 			VARCHAR(30) NOT NULL,
	CRO_S_DESCRIPTION		VARCHAR(60),
	PRIMARY KEY(CRO_N_ROLE_ID),
	UNIQUE(CRO_S_NAME)
);

CREATE TABLE BSST_CRL_COMPANY_ROLE_LANG(
	...
	CONSTRAINT BSST_CRL_COMPANY_ROLE_LANG_FK1 FOREIGN KEY(CRO_N_ROLE_ID) REFERENCES BSST_CRO_COMPANY_ROLE(CRO_N_ROLE_ID),
	CONSTRAINT BSST_CRL_COMPANY_ROLE_LANG_FK2 FOREIGN KEY(LAN_N_LANG_ID) REFERENCES BSST_LAN_LANGUAGE(LAN_N_LANG_ID)
);
...
CREATE TABLE BSST_CPE_COMPANY_PERS(
	...
	CPE_D_DATE_FROM			DATE NOT NULL,
	CPE_D_DATE_TO			DATE NOT NULL,	
	PRIMARY KEY(COM_N_COMPANY_ID,PER_N_PERSON_ID,CRO_N_ROLE_ID,CDE_N_DEPT_ID,CPE_D_DATE_FROM),
	CONSTRAINT BSST_CPE_COMPANY_PERS_FK1 FOREIGN KEY(COM_N_COMPANY_ID) REFERENCES BSST_COM_COMPANY(COM_N_COMPANY_ID),
	CONSTRAINT BSST_CPE_COMPANY_PERS_FK2 FOREIGN KEY(COM_N_COMPANY_ID) REFERENCES BSST_PER_PERSON(PER_N_PERSON_ID),
	CONSTRAINT BSST_CPE_COMPANY_PERS_FK3 FOREIGN KEY(CRO_N_ROLE_ID) REFERENCES BSST_CRO_COMPANY_ROLE(CRO_N_ROLE_ID),
	CONSTRAINT BSST_CPE_COMPANY_PERS_FK4 FOREIGN KEY(CDE_N_DEPT_ID) REFERENCES BSST_CDE_COMPANY_DEPT(CDE_N_DEPT_ID)
);
