...
FISCAL_CODE,VAT_CODE,HEAD_DEPT_ID,HEAD_DEPT_CODE,HEAD_DEPT_NAME,
GROUP_ID,GROUP_CODE,GROUP_NAME
)
as
select
	a.COM_N_COMPANY_ID,a.COM_S_CODE,a.COM_S_NAME,a.COM_S_ADDRESS,a.COM_S_ZIP,
	a.CIT_N_CITY_ID,c.CIT_S_NAME,d.CON_S_NAME,a.COM_S_FISCAL_CODE,a.COM_S_VAT_CODE,
	b.CDE_N_DEPT_ID, b.CDE_S_CODE, b.CDE_S_NAME,
	...
	left join BSST_CGR_COMPANY_GROUP e on e.CGR_N_COMPANY_ID=a.COM_N_COMPANY_ID
	left join BSST_COM_COMPANY f on f.COM_N_COMPANY_ID=e.CGR_N_GROUP_ID
